...
3. Review the writeups and screenshots.
4. Run the code or reproduce the lab steps only in your own safe environment.
...
All testing was done in safe, authorized lab environments.
